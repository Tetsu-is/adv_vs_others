...
int main(int argc, char **argv)
{
    ...
    // sprintf(output, "../results/AdvGreedySelectAnchor/AdvGreedySelectAnchor-%s_b=%d", argv[1], budget);
    ...
    int sumNum = 0;
    // TODO: budget < 探索済みノード数 の場合は途中で止まるようにする
